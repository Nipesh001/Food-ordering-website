    ...
    const fetchBuyFoodData = async () => {
      ...
      try {
        const response = await axios.post(
          `http://localhost:4001/api/v1/food/buy/${foodId}`,
          {},
          {
            headers: {
        ...
        <div className="flex flex-col sm:flex-row my-40 container mx-auto">
          <div className="w-full md:w-1/2">
            ...
            <div className="flex items-center text-center space-x-2">
              <h1 className="text-gray-600 text-sm">food name</h1>
              <p className="text-red-500 font-bold">{food.title}</p>
            </div>
          </div>
